...
player_1_selection = (input("Select 0 for Rock, 1 for Paper and 2 for Scissors\n"))


if player_1_selection == '0' or player_1_selection == '1' or player_1_selection == '2':
    player_1_selection = int(player_1_selection)
    print("You Chose")
